...
export const OUTCOME_ROW: Record<DoseOutcome, string> = {
  taken: 'border-taken/35 bg-taken/[0.07]',
  skipped: 'border-skipped/40 bg-skipped/[0.08]',
  missed: 'border-dashed border-border bg-transparent',
...
export const OUTCOME_POCKET: Record<DoseOutcome, string> = {
  taken: 'border-taken bg-taken text-taken-contrast',
  skipped: 'border-skipped bg-skipped text-skipped-contrast',
...
export const OUTCOME_CELL: Record<DoseOutcome, string> = {
  taken: 'border-taken bg-taken',
  skipped: 'border-skipped bg-skipped',
